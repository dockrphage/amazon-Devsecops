pipeline {
    ...
    stages {
        ...
        stage("Git Checkout") {
            steps {
                git branch: 'main', url: 'https://github.com/dockrphage/amazon-Devsecops.git'
            }
        }
        ...
        stage("Build Docker Image") {
            steps {
                script {
                    env.IMAGE_TAG = "dockrphage/amazon:${BUILD_NUMBER}"
            ...
            steps {
                script {
                    withCredentials([string(credentialsId: 'docker-cred', variable: 'dockerpwd')]) {
                        ...
                        // Also push latest
                        sh "docker tag amazon dockrphage/amazon:latest"
                        sh "docker push dockrphage/amazon:latest"
                    }
                }
            }
        }
    ...
    always {
        script {
            ...
            emailext (
                ...
                """,
                to: 'abpillai09@gmail.com',
                from: 'abpillai09@gmail.com',
                mimeType: 'text/html',
